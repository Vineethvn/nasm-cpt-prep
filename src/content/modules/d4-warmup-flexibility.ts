...
export const warmupFlexibility: Module = {
  ...
  items: [
    ...
    { kind: 'typein', id: 'wf-t8', tags: ['flexibility'], prompt: 'Which flexibility type uses active-isolated stretching and is used in Phases 2–3?', accept: ['active flexibility', 'active'], hints: ['Named for how the joint moves.', 'A_____ flexibility'], explanation: 'Active flexibility = SMR + active-isolated stretching, Phases 2–3.' },
    { kind: 'typein', id: 'wf-t9', tags: ['flexibility'], prompt: 'How long is each hold in active-isolated stretching?', accept: ['1-2 seconds', '1-2 sec', '1 to 2 seconds'], hints: ['Very brief.', '_-_ seconds'], explanation: 'Active-isolated stretching uses 1–2 second holds for 5–10 reps.' },
    { kind: 'typein', id: 'wf-t10', tags: ['flexibility'], prompt: 'How many reps are performed in active-isolated stretching?', accept: ['5-10', '5-10 reps'], hints: ['A moderate range.', '_-__ reps'], explanation: 'Active-isolated stretching uses 5–10 reps per stretch.' },
    { kind: 'typein', id: 'wf-t11', tags: ['flexibility'], prompt: 'How many reps are typically performed in dynamic stretching (functional flexibility)?', accept: ['10', '10 reps'], hints: ['A round number.', '__ reps'], explanation: 'Dynamic stretching uses roughly 10 reps across 3–10 exercises.' },
    { kind: 'typein', id: 'wf-t12', tags: ['smr'], prompt: 'Roughly how long should you hold the roller on a tender spot during SMR?', accept: ['30 seconds', '30 sec', '~30 seconds'], hints: ['Half a minute.', '__ seconds'], explanation: 'SMR is typically held on a tender spot for about 30 seconds (some sources say 30–90s — see VERIFY.md).' },
    { kind: 'typein', id: 'wf-t13', tags: ['workout-order'], prompt: 'In the standard OPT workout order, what comes immediately BEFORE resistance training?', accept: ['saq', 'speed agility quickness'], hints: ['Three-letter abbreviation.', 'S__'], explanation: 'Order: warm-up → core → balance → plyometric → SAQ → resistance → cool-down.' },
    { kind: 'typein', id: 'wf-t14', tags: ['workout-order'], prompt: 'Which two components make up the warm-up in an OPT session?', accept: ['smr and flexibility', 'smr, flexibility', 'self-myofascial release and flexibility'], hints: ['Rolling, then stretching.', 'S__ and F___________'], explanation: 'The warm-up is SMR followed by the appropriate flexibility technique for the phase.' },
    {
      kind: 'scenario', id: 'wf-s1', tags: ['flexibility'],
      story: 'A Phase 1 client has an overactive hip flexor complex identified during the overhead squat assessment (low back arches).',
      question: 'What flexibility approach is most appropriate?',
      options: [
        'SMR then static stretching of the hip flexors (corrective flexibility)',
        'Dynamic stretching only (functional flexibility)',
        'Active-isolated stretching only, skipping SMR',
        'No flexibility work — strengthen the glutes instead',
      ],
      answer: 0,
      explanation: 'Corrective flexibility (SMR + static stretch, ~30s hold) is the Phase 1 approach for lengthening an identified overactive muscle.',
      whyWrong: ['', 'Dynamic stretching is functional flexibility, used in Phases 4–5, not for correcting an overactive muscle in Phase 1.', 'Active flexibility belongs to Phases 2–3, and SMR should precede stretching regardless.', 'Strengthening the underactive glutes is part of the plan, but the overactive tissue still needs lengthening first.'],
    },
    {
      kind: 'scenario', id: 'wf-s2', tags: ['flexibility', 'scope'],
      story: 'A new client mentions they had shoulder surgery four months ago and still has movement restrictions. They ask the trainer to stretch the shoulder aggressively.',
      question: 'What should the trainer consider first?',
      options: [
        'The client\'s general lifestyle and goals',
        'Any medical precautions or contraindications from the intake',
        'Their overhead squat results only',
        'Their preferred stretching style',
      ],
      answer: 1,
      explanation: 'Medical precautions and contraindications take priority over any programming preference — a recent surgery requires clearance before aggressive stretching.',
      whyWrong: ['Lifestyle and goals matter, but medical safety information comes first.', '', 'Movement assessment is useful but does not override documented medical precautions.', 'Client preference does not override medical safety considerations.'],
    },
    {
      kind: 'mcq', id: 'wf-m2', tags: ['smr'], source: 'original',
      prompt: 'Which statement best describes how SMR produces its effect?',
      options: [
        'It releases growth hormone, enhancing performance',
        'It stimulates nerve receptors, producing tissue relaxation and reduced pain',
        'It increases eccentric contraction to drive hypertrophy',
        'It causes delayed onset muscle soreness 72 hours later',
      ],
      answer: 1,
      explanation: 'SMR works neurophysiologically — compressing the tissue stimulates nerve receptors, producing relaxation and reduced pain sensitivity.',
      whyWrong: ['SMR is not described as an endocrine/growth-hormone mechanism.', '', 'SMR is passive compression, not an eccentric contraction stimulus.', 'SMR is a recovery/preparation tool, not a cause of DOMS.'],
    },
    {
      kind: 'mcq', id: 'wf-m3', tags: ['workout-order'], source: 'original',
      prompt: 'Which sequence reflects the correct OPT session order?',
      options: [
        'Resistance → core → balance → plyometric → warm-up → cool-down',
        'Warm-up → core → balance → plyometric → SAQ → resistance → cool-down',
        'Warm-up → resistance → core → SAQ → plyometric → cool-down',
        'Core → warm-up → resistance → balance → plyometric → cool-down',
      ],
      answer: 1,
      explanation: 'The standard order is warm-up (SMR + flexibility) → core → balance → plyometric → SAQ → resistance training → cool-down.',
      whyWrong: ['The warm-up cannot come near the end of the session.', '', 'Resistance training comes after core, balance, plyometric, and SAQ, not immediately after warm-up.', 'The warm-up always comes first.'],
    },
    {
      kind: 'mcq', id: 'wf-m4', tags: ['smr'], source: 'original',
      prompt: 'A roller is placed on the front and slightly outside portion of the upper thigh, just below the pelvis. Which muscle is being targeted?',
      options: ['Adductors', 'Piriformis', 'Tensor fascia latae', 'Hamstrings'],
      answer: 2,
      explanation: 'The front-lateral upper thigh just below the pelvis is the TFL placement.',
      whyWrong: ['Adductors are rolled on the inner thigh.', 'The piriformis is rolled in the gluteal region.', '', 'Hamstrings are rolled on the posterior thigh.'],
    },
    {
      kind: 'mcq', id: 'wf-m5', tags: ['flexibility'], source: 'original',
      prompt: 'Why is static stretching generally paired with SMR in corrective flexibility?',
      options: [
        'SMR reduces tissue tension first, making the subsequent stretch more effective',
        'SMR replaces the need for stretching entirely',
        'SMR warms the muscle so it can be loaded heavily immediately',
        'The order does not matter',
      ],
      answer: 0,
      explanation: 'SMR first reduces tension/tone in the overactive tissue via nerve receptor stimulation, so the static stretch that follows can lengthen the tissue more effectively.',
      whyWrong: ['', 'SMR and stretching serve different, complementary purposes.', 'SMR is not a substitute for a full warm-up before heavy loading.', 'Order matters — SMR precedes stretching in all three flexibility categories.'],
    },
    {
      kind: 'match', id: 'wf-match2', tags: ['flexibility'],
      prompt: 'Match each flexibility type to its stretching technique.',
      pairs: [
        ['Corrective flexibility', 'SMR + static stretch (~30s hold)'],
        ['Active flexibility', 'SMR + active-isolated (1–2s hold, 5–10 reps)'],
        ['Functional flexibility', 'SMR + dynamic stretching (~10 reps)'],
      ],
